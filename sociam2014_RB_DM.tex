...
%\includegraphics[width=7.5cm]{graph1}\caption[width=7]{ $G_1$, network graph corresponding to the mailing list prior to the ToSBack bot contributions, with the longest branch coloured in red}
