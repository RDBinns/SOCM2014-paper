...
\begin{figure}[H]
\includegraphics[width=7.5cm]{graph1}\caption[width=7]{ $G_1$, network graph corresponding to the mailing list prior to the ToSBack bot contributions, with the longest branch coloured in red}\label{fig:t1}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=7.5cm]{graph2}\caption{ $G_2$, network graph corresponding to the mailing list after the ToSBack bot contributions began}\label{fig:t2}
\end{figure}
